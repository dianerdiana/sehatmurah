        ...
        <form action="search-result" method="" className="w-full">
          <div id="form" className="w-full rounded-3xl bg-white px-4 py-8">
            ...
            <div id="InputContainer">
              ...
              >
                <img
                  src="assets/icons/doctorsearch-search-doctor.svg"
                  alt="Icon"
                />
                <span className="font-jakarta font-bold leading-[20.16px] text-white">
                  Search Doctor
                </span>
              </button>
            </div>
          ...
          <div
            id="myModal"
            className="absolute left-0 right-0 top-12 z-50 hidden pb-[208px]"
          >
      ...
      <nav className="navigate fixed bottom-0 left-0 right-0 z-30 mx-auto">
        <div className="mx-auto max-w-[640px]">
          <div className="flex items-center justify-between rounded-t-2xl border-t border-gray-50 bg-white px-4 py-6">
            ...
            >
              <img
                src="assets/icons/homepage-nav-home-nonactive.svg"
                alt="Icon"
              />
            ...
            >
              <img
                src="assets/icons/homepage-nav-appointment-active.svg"
                alt="Icon"
              />
