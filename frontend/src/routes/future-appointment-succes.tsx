      ...
      <section id='ContainertDetails' className='-mt-[149px] w-full space-y-4 pb-4'>
        <section id='DetailsAppointment' className='mx-4 overflow-hidden rounded-3xl'>
          ...
          >
            ...
            <div>
              <h2 className='mb-1 font-jakarta text-xl font-bold leading-[25.2px] text-white'>Your Order Is Succes</h2>
              <p className='font-jakarta font-semibold leading-[20.16px] text-accent-teal'>Your order is confirmed.</p>
            </div>
          </div>
