...
function DoctorDetailsPage() {
  return (
    <main className='relative mx-auto max-w-[640px] pb-[120px]'>
      ...
      <section id='ContainerDetails' className='-mt-[91px] w-full space-y-4 pb-4'>
          ...
          <div id='CardInfo' className='flex items-center justify-evenly rounded-2xl border border-gray-200 py-4'>
            ...
            <div className='grid w-[80.33px] place-items-center'>
              <div className='mb-1 flex gap-[2px]'>
                ...
                <h4 className='font-jakarta font-bold leading-[20.16px] whitespace-nowrap text-gray-900'>5 Years</h4>
              </div>
        ...
        <section id='About' className='w-full rounded-3xl bg-white px-4 py-8'>
          <h2 className='mb-4 font-jakarta text-xl font-bold leading-[25.2px] text-gray-900'>About Doctor</h2>
          <div className='w-full space-y-4 rounded-3xl border border-gray-200 p-6'>
            ...
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='font-jakarta font-semibold leading-[20.16px] text-gray-500'>College graduate</p>
              </div>
            ...
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='font-jakarta font-semibold leading-[20.16px] text-gray-500'>Official Achievement</p>
              </div>
              <img src='assets/image/doctordetails-official-achievement.png' alt='Image' className='size-6' />
            </div>
          </div>
        </section>
        ...
        <section id='Reviews' className='w-full rounded-3xl bg-white px-4 py-8'>
          <div className='mb-4 flex justify-between'>
            <h2 className='font-jakarta text-xl font-bold leading-[25.2px] text-gray-900'>Reviews and Ratings</h2>
            <a href='#' className='font-jakarta text-sm font-bold leading-[17.64px] text-gray-500'>
              View All
            </a>
          </div>
          <div className='space-y-6 rounded-3xl border border-gray-200 p-6'>
            <div id='rating' className='flex items-center justify-between'>
              ...
              <div>
                <img src='assets/icons/doctordetails-stars.svg' alt='Icon' className='mb-2' loading='lazy' />
                <p className='font-jakarta font-semibold leading-[20.16px] text-gray-500'>1250+ Reviews</p>
              </div>
            </div>
            <hr className='w-full border-gray-200' />
            <article id='Review1'>
              <div className='mb-[21px] flex items-center justify-between'>
                <div className='flex items-center'>
                  ...
                  />
                  <div>
                    <h3 className='mb-1 font-jakarta font-bold leading-[22.68px] text-gray-900'>Nabila Geeqo</h3>
                    <p className='font-jakarta font-semibold leading-[20.16px] text-gray-500'>30 min ago</p>
                  </div>
                </div>
                <div className='flex h-8 w-[61px] items-center rounded-md bg-[#FFB06317] p-[6px]'>
                  <img
                    ...
                    loading='lazy'
                  />
                  <p className='font-jakarta font-bold leading-[20.16px] text-accent-orange'>4.5</p>
                </div>
              </div>
              <p className='font-jakarta font-semibold leading-[25.6px] text-gray-500'>
                "Excellent service! Dr. Raze Invoker was attentive and thorough. The clinic was clean, and the staff
            ...
            <article id='Review2'>
              <div className='mb-[21px] flex items-center justify-between'>
                <div className='flex items-center'>
                  ...
                  />
                  <div>
                    <h3 className='mb-1 font-jakarta font-bold leading-[22.68px] text-gray-900'>Dire Clove</h3>
                    <p className='font-jakarta font-semibold leading-[20.16px] text-gray-500'>A week ago</p>
                  </div>
                </div>
                <div className='flex h-8 w-[61px] items-center rounded-md bg-[#FFB06317] p-[6px]'>
                  <img
                    ...
                    loading='lazy'
                  />
                  <p className='font-jakarta font-bold leading-[20.16px] text-accent-orange'>5.0</p>
                </div>
              </div>
              <p className='font-jakarta font-semibold leading-[25.6px] text-gray-500'>
                "Quick and easy appointment! Dr. Raze Invoker was professional, and the staff made me feel comfortable.
                Highly recommend!"
              </p>
            </article>
          </div>
