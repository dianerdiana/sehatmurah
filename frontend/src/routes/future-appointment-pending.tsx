...
export const Route = createFileRoute('/future-appointment-pending')({
...
function RouteComponent() {
  return (
    <main className='relative mx-auto max-w-[640px] pb-[192px]'>
      ...
      <section id='ContainertDetails' className='-mt-[149px] w-full space-y-4 pb-4'>
        <section id='DetailsAppointment' className='mx-4 overflow-hidden rounded-3xl'>
          <div className='alert -mb-[22px] flex items-center gap-x-3 bg-accent-cream px-5 pb-[46px] pt-6'>
            <img src='assets/icons/futureappointment-alert-pending.svg' alt='Icon' />
            <div>
              <h2 className='mb-1 font-jakarta text-xl font-bold leading-[25.2px] text-gray-900'>
                Your Order Is Pending
              </h2>
              <p className='font-jakarta font-semibold leading-[20.16px] text-accent-gold'>
        ...
        <section id='PaymentDetails' className='w-full space-y-4 rounded-3xl bg-white px-4 py-8'>
          ...
          <div className='w-full space-y-4 rounded-3xl border border-gray-200 p-6'>
            <div className='flex items-center justify-between'>
              <p className='font-jakarta font-semibold leading-[20.16px] text-gray-500'>Booking Code</p>
              <strong>
        ...
        <section id='Location' className='w-full rounded-3xl bg-white px-4 py-8'>
          <h2 className='mb-4 font-jakarta text-xl font-bold leading-[25.2px] text-gray-900'>Check-Up Location</h2>
          <div id='ContainerMap' className='relative'>
            <div id='Map' className='h-[280px] w-full max-w-full overflow-hidden rounded-3xl'>
            ...
            <div id='CtaMap' className='absolute bottom-4 w-full px-4'>
              <div className='flex items-center justify-between rounded-2xl bg-white p-3'>
                <div className='flex items-center gap-[10px]'>
                  <img src='assets/icons/doctordetails-location-map.svg' alt='Icon' />
                  <div>
                    <h3 className='mb-1 font-jakarta text-[18px] font-bold leading-[22.68px] text-gray-900'>
                      Radiant Hospital
                    </h3>
                    <p className='font-jakarta font-semibold leading-[20.16px] text-gray-500'>Jakarta, Indonesia</p>
                  </div>
                </div>
                <a href='#' className='font-jakarta text-sm font-semibold leading-[17.64px] text-primary'>
                  See Map
                </a>
              </div>
            </div>
