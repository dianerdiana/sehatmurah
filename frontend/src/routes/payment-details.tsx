...
function RouteComponent() {
  return (
    <main className='relative mx-auto max-w-[640px] pb-[120px]'>
      ...
      <section id='ContainertDetails' className='-mt-[146px] w-full space-y-4 pb-4'>
        <section id='DetailsAppointment' className='mx-4 rounded-3xl bg-white p-5'>
          <h2 className='mb-4 font-jakarta text-xl font-bold leading-[25.2px] text-gray-900'>Details Appointment</h2>
          <div className='mb-4 w-full space-y-4 rounded-3xl border border-gray-200 p-6'>
            <div className='flex items-center justify-between'>
              <div>
                <h3 className='mb-[2px] font-jakarta text-lg font-bold leading-[22.68px] text-gray-900'>31 Aug 2024</h3>
            ...
            <div className='flex items-center justify-between'>
              <div>
                <h3 className='mb-[2px] font-jakarta text-lg font-bold leading-[22.68px] text-gray-900'>13:00 PM</h3>
                <p className='font-jakarta font-semibold leading-[20.16px] text-gray-500'>Appointment Time</p>
              </div>
            ...
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='font-jakarta font-semibold leading-[20.16px] text-gray-500'>Appointment Location</p>
              </div>
          ...
          <div id='Doctor' className='flex w-full items-center gap-3 rounded-3xl bg-[#2C40FF08] p-4'>
            ...
            <div>
              <h3 className='mb-1 font-jakarta text-lg font-bold leading-[22.68px] text-gray-900'>Dr. Raze Invoker</h3>
              <p className='font-jakarta font-semibold leading-[20.16px] text-gray-500'>Internist Specialist</p>
            </div>
          </div>
        </section>
        <section id='PaymentDetails' className='mb-4 w-full space-y-4 rounded-3xl bg-white px-4 py-8'>
          <h2 className='font-jakarta text-xl font-bold leading-[25.2px] text-gray-900'>Payment Details</h2>
          <div className='w-full space-y-4 rounded-3xl border border-gray-200 p-6'>
            <div className='flex items-center justify-between'>
              <p className='font-jakarta font-semibold leading-[20.16px] text-gray-500'>Duration</p>
              <p className='font-jakarta text-lg font-bold leading-[22.68px] text-gray-900'>1 Hour</p>
            </div>
            <div className='flex items-center justify-between'>
              <p className='font-jakarta font-semibold leading-[20.16px] text-gray-500'>Price</p>
              <p className='font-jakarta text-lg font-bold leading-[22.68px] text-gray-900'>Rp 240.000</p>
            </div>
            <div className='flex items-center justify-between'>
              <p className='font-jakarta font-semibold leading-[20.16px] text-gray-500'>PPN 11%</p>
              <p className='font-jakarta text-lg font-bold leading-[22.68px] text-gray-900'>Rp 10.000</p>
            </div>
            <hr className='w-full border-gray-200' />
            <div className='flex items-center justify-between'>
              <p className='font-jakarta font-semibold leading-[20.16px] text-gray-500'>Grand Total</p>
              <p className='font-jakarta text-lg font-bold leading-[22.68px] text-gray-900'>Rp 249.675</p>
            </div>
          </div>
        </section>
        <form action='succes-page' method=''>
          <section id='BankTransfer' className='mb-4 w-full rounded-3xl bg-white px-4 py-8'>
            <h2 className='mb-6 font-jakarta text-xl font-bold leading-[25.2px] text-gray-900'>Bank Transfer</h2>
            <div className='container-input-bank space-y-6'>
              ...
              >
                <label className='flex items-center justify-between'>
                  <img
                    ...
                    loading='lazy'
                  />
                  <input required type='radio' name='banking' className='size-6 rounded-full p-1 accent-primary' />
                </label>
                ...
                >
                  <div>
                    <p id='bcaTitle' className='mb-1 font-jakarta font-semibold leading-[20.16px] text-gray-500'>
                      Sehat - BCA Bank
                    </p>
                    <p id='bcaNumber' className='font-jakarta text-lg font-bold leading-[22.68px] text-gray-900'>
                      1935 0009 1200
                    </p>
                  </div>
              ...
              >
                ...
                >
                  <div>
                    <p id='bniTitle' className='mb-1 font-jakarta font-semibold leading-[20.16px] text-gray-500'>
                      Sehat - BNI Bank
                    </p>
                    <p id='bniNumber' className='font-jakarta text-lg font-bold leading-[22.68px] text-gray-900'>
                      1111 0009 1200
                    </p>
                  </div>
                  <img src='assets/icons/paymentdetails-copy.svg' alt='Icon' />
              ...
              >
                ...
                >
                  <div>
                    <p id='briTitle' className='mb-1 font-jakarta font-semibold leading-[20.16px] text-gray-500'>
                      Sehat - BRI Bank
                    </p>
                    <p id='briNumber' className='font-jakarta text-lg font-bold leading-[22.68px] text-gray-900'>
                      2222 0009 1200
                    </p>
                  </div>
                  <img src='assets/icons/paymentdetails-copy.svg' alt='Icon' />
          ...
          <section id='BankAccount' className='mb-4 w-full space-y-6 rounded-3xl bg-white px-4 py-8'>
            <h2 className='font-jakarta text-xl font-bold leading-[25.2px] text-gray-900'>Your Bank Account</h2>
            <label id='BankName' className='block'>
              <p className='mb-3 font-jakarta font-semibold leading-[20.16px] text-gray-500'>Bank Name</p>
            ...
            <label id='BankAccountName' className='block'>
              <p className='mb-3 font-jakarta font-semibold leading-[20.16px] text-gray-500'>Bank Account Name</p>
              <div className='relative'>
                <input
                  type='text'
            ...
            <label id='BankAccountNumber' className='block'>
              <p className='mb-3 font-jakarta font-semibold leading-[20.16px] text-gray-500'>Bank Account Number</p>
              <div className='relative'>
                <input
                  type='text'
                  value=''
          ...
          <section id='PersonalInformations' className='relative -mb-6 w-full space-y-6 rounded-3xl bg-white px-4 py-8'>
            <h2 className='font-jakarta text-xl font-bold leading-[25.2px] text-gray-900'>Personal Informations</h2>
            <label id='FullName' className='block'>
              <p className='mb-3 font-jakarta font-semibold leading-[20.16px] text-gray-500'>Full Name</p>
              <div className='relative'>
                <input
                  value=''
                  id='fullName'
            ...
            <label id='Email' className='block'>
              <p className='mb-3 font-jakarta font-semibold leading-[20.16px] text-gray-500'>Email Address</p>
              <div className='relative'>
                <input
                  id='email'
                  type='email'
          ...
          >
            <h3 className='text-center font-jakarta font-bold leading-[22.4px] text-white'>
              We will send the receipt to this Email. Please enter the correct information.
            </h3>
          </section>
          <nav id='Cta' className='fixed bottom-0 left-0 right-0 z-30'>
            <div className='mx-auto max-w-[640px]'>
              <div className='flex h-[120px] w-full items-center justify-between space-x-2 rounded-t-3xl bg-white px-4'>
                <div>
                  <p className='font-jakarta font-semibold leading-[20.16px] text-gray-500'>Grandtotal:</p>
