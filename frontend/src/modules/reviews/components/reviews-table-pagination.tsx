...
type ReviewsTablePaginationProps = {
  page: number;
  limit: number;
  totalItems: number;
  totalPages?: number;
...
export function ReviewsTablePagination({
  page,
  limit,
  totalItems,
  totalPages,
      ...
      <CardContent className='flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between'>
        ...
        <div className='flex flex-wrap items-center gap-2'>
          <p className='text-sm text-muted-foreground'>
            {totalItems === 0 ? 'No review data available' : `${totalItems} total reviews`}
          </p>
