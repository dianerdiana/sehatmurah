...
type SpecialistsTablePaginationProps = {
  page: number;
  limit: number;
  totalItems: number;
  totalPages?: number;
...
export function SpecialistsTablePagination({
  page,
  limit,
  totalItems,
  totalPages,
  onPageChange,
  onLimitChange,
}: SpecialistsTablePaginationProps) {
      ...
      <CardContent className='flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between'>
        ...
        <div className='flex flex-wrap items-center gap-2'>
          <p className='text-sm text-muted-foreground'>
            {totalItems === 0 ? 'No specialist data available' : `${totalItems} total specialists`}
          </p>
