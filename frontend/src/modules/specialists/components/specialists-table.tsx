...
import { specialistsColumns } from './columns';
...
export function SpecialistsTable({ data, sorting, onSortingChange, isLoading = false }: SpecialistsTableProps) {
      ...
      <Table>
        ...
        <TableBody>
          {isLoading ? (
            ...
            <TableRow>
              <TableCell colSpan={specialistsColumns.length} className='h-32 text-center'>
