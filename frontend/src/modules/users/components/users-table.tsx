...
export function UsersTable({ data, sorting, onSortingChange, isLoading = false }: UsersTableProps) {
      ...
      <Table>
        ...
        <TableBody>
          {isLoading ? (
            ...
            <TableRow>
              <TableCell colSpan={usersColumns.length} className='h-32 text-center'>
                No users found.
              </TableCell>
            </TableRow>
          )}
