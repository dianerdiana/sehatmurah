...
export function DoctorsTable({ data, sorting, onSortingChange, isLoading = false }: DoctorsTableProps) {
      ...
      <Table>
        ...
        <TableBody>
          {isLoading ? (
            ...
            <TableRow>
              <TableCell colSpan={doctorsColumns.length} className='h-32 text-center'>
                No doctors found.
              </TableCell>
            </TableRow>
          )}
